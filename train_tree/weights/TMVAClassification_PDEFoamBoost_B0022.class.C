...
Method         : PDEFoam::PDEFoamBoost_B0022
...
class ReadPDEFoamBoost_B0022 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0022( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0022" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0022() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0022::GetMvaValue( const std::vector<double>& inputValues ) const
   {
