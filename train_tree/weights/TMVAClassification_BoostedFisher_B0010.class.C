...
Method         : Fisher::BoostedFisher_B0010
...
class ReadBoostedFisher_B0010 : public IClassifierReader {

 public:

   // constructor
   ReadBoostedFisher_B0010( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadBoostedFisher_B0010" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadBoostedFisher_B0010() {
...
inline void ReadBoostedFisher_B0010::Initialize() 
{
   fFisher0 = -0.246567295207;
   fFisherCoefficients.push_back( -0.00978338073987 );
   fFisherCoefficients.push_back( 0.0281821535419 );
   fFisherCoefficients.push_back( -0.0199052358536 );
   fFisherCoefficients.push_back( 0.000465383342999 );
   fFisherCoefficients.push_back( -0.000129573774691 );
...
inline double ReadBoostedFisher_B0010::GetMvaValue__( const std::vector<double>& inputValues ) const
{
...
// Clean up
inline void ReadBoostedFisher_B0010::Clear() 
{
   // clear coefficients
   fFisherCoefficients.clear(); 
}
   inline double ReadBoostedFisher_B0010::GetMvaValue( const std::vector<double>& inputValues ) const
   {
