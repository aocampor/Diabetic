...
Method         : Fisher::BoostedFisher_B0012
...
class ReadBoostedFisher_B0012 : public IClassifierReader {

 public:

   // constructor
   ReadBoostedFisher_B0012( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadBoostedFisher_B0012" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadBoostedFisher_B0012() {
...
inline void ReadBoostedFisher_B0012::Initialize() 
{
   fFisher0 = -0.212745751641;
   fFisherCoefficients.push_back( -0.00861016336649 );
   fFisherCoefficients.push_back( 0.0245886849362 );
   fFisherCoefficients.push_back( -0.0174339690496 );
   fFisherCoefficients.push_back( 0.000440625591512 );
   fFisherCoefficients.push_back( -0.000114250889964 );
...
inline double ReadBoostedFisher_B0012::GetMvaValue__( const std::vector<double>& inputValues ) const
{
...
// Clean up
inline void ReadBoostedFisher_B0012::Clear() 
{
   // clear coefficients
   fFisherCoefficients.clear(); 
}
   inline double ReadBoostedFisher_B0012::GetMvaValue( const std::vector<double>& inputValues ) const
   {
