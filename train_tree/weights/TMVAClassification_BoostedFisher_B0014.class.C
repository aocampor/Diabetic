...
Method         : Fisher::BoostedFisher_B0014
...
class ReadBoostedFisher_B0014 : public IClassifierReader {

 public:

   // constructor
   ReadBoostedFisher_B0014( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadBoostedFisher_B0014" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadBoostedFisher_B0014() {
...
inline void ReadBoostedFisher_B0014::Initialize() 
{
   fFisher0 = -0.202561578714;
   fFisherCoefficients.push_back( -0.00812879297405 );
   fFisherCoefficients.push_back( 0.023211511473 );
   fFisherCoefficients.push_back( -0.0164245731245 );
   fFisherCoefficients.push_back( 0.000414361073782 );
   fFisherCoefficients.push_back( -0.000116782888991 );
...
inline double ReadBoostedFisher_B0014::GetMvaValue__( const std::vector<double>& inputValues ) const
{
...
// Clean up
inline void ReadBoostedFisher_B0014::Clear() 
{
   // clear coefficients
   fFisherCoefficients.clear(); 
}
   inline double ReadBoostedFisher_B0014::GetMvaValue( const std::vector<double>& inputValues ) const
   {
