...
Method         : PDEFoam::PDEFoamBoost_B0012
...
class ReadPDEFoamBoost_B0012 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0012( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0012" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0012() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0012::GetMvaValue( const std::vector<double>& inputValues ) const
   {
