...
Method         : PDEFoam::PDEFoamBoost_B0015
...
class ReadPDEFoamBoost_B0015 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0015( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0015" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0015() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0015::GetMvaValue( const std::vector<double>& inputValues ) const
   {
