...
Method         : PDEFoam::PDEFoamBoost_B0025
...
class ReadPDEFoamBoost_B0025 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0025( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0025" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0025() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0025::GetMvaValue( const std::vector<double>& inputValues ) const
   {
