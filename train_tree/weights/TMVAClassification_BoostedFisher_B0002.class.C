...
Method         : Fisher::BoostedFisher_B0002
...
class ReadBoostedFisher_B0002 : public IClassifierReader {

 public:

   // constructor
   ReadBoostedFisher_B0002( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadBoostedFisher_B0002" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadBoostedFisher_B0002() {
...
inline void ReadBoostedFisher_B0002::Initialize() 
{
   fFisher0 = -0.387749108044;
   fFisherCoefficients.push_back( -0.0179870915778 );
   fFisherCoefficients.push_back( 0.0535471002138 );
   fFisherCoefficients.push_back( -0.0377217172344 );
   fFisherCoefficients.push_back( 0.000430051929891 );
   fFisherCoefficients.push_back( -0.000184130988926 );
...
inline double ReadBoostedFisher_B0002::GetMvaValue__( const std::vector<double>& inputValues ) const
{
...
// Clean up
inline void ReadBoostedFisher_B0002::Clear() 
{
   // clear coefficients
   fFisherCoefficients.clear(); 
}
   inline double ReadBoostedFisher_B0002::GetMvaValue( const std::vector<double>& inputValues ) const
   {
