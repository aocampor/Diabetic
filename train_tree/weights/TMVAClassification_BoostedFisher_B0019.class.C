...
Method         : Fisher::BoostedFisher_B0019
...
class ReadBoostedFisher_B0019 : public IClassifierReader {

 public:

   // constructor
   ReadBoostedFisher_B0019( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadBoostedFisher_B0019" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadBoostedFisher_B0019() {
...
inline void ReadBoostedFisher_B0019::Initialize() 
{
   fFisher0 = -0.179753038305;
   fFisherCoefficients.push_back( -0.00712879258939 );
   fFisherCoefficients.push_back( 0.0202870940239 );
   fFisherCoefficients.push_back( -0.0143335028218 );
   fFisherCoefficients.push_back( 0.000375095402241 );
   fFisherCoefficients.push_back( -0.000106445712177 );
...
inline double ReadBoostedFisher_B0019::GetMvaValue__( const std::vector<double>& inputValues ) const
{
...
// Clean up
inline void ReadBoostedFisher_B0019::Clear() 
{
   // clear coefficients
   fFisherCoefficients.clear(); 
}
   inline double ReadBoostedFisher_B0019::GetMvaValue( const std::vector<double>& inputValues ) const
   {
