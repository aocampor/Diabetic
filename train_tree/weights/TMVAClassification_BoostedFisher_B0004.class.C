...
Method         : Fisher::BoostedFisher_B0004
...
class ReadBoostedFisher_B0004 : public IClassifierReader {

 public:

   // constructor
   ReadBoostedFisher_B0004( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadBoostedFisher_B0004" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadBoostedFisher_B0004() {
...
inline void ReadBoostedFisher_B0004::Initialize() 
{
   fFisher0 = -0.355220451047;
   fFisherCoefficients.push_back( -0.014720827854 );
   fFisherCoefficients.push_back( 0.0435958583934 );
   fFisherCoefficients.push_back( -0.0306558686131 );
   fFisherCoefficients.push_back( 0.000471672481448 );
   fFisherCoefficients.push_back( -0.000184529028215 );
...
inline double ReadBoostedFisher_B0004::GetMvaValue__( const std::vector<double>& inputValues ) const
{
...
// Clean up
inline void ReadBoostedFisher_B0004::Clear() 
{
   // clear coefficients
   fFisherCoefficients.clear(); 
}
   inline double ReadBoostedFisher_B0004::GetMvaValue( const std::vector<double>& inputValues ) const
   {
