...
Method         : PDEFoam::PDEFoamBoost_B0013
...
class ReadPDEFoamBoost_B0013 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0013( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0013" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0013() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0013::GetMvaValue( const std::vector<double>& inputValues ) const
   {
