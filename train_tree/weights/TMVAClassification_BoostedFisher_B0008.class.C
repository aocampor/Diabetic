...
{
   fFisher0 = -0.265577392267;
   fFisherCoefficients.push_back( -0.0106610704245 );
   fFisherCoefficients.push_back( 0.0307794512866 );
   fFisherCoefficients.push_back( -0.0218043400866 );
   fFisherCoefficients.push_back( 0.00050472590389 );
   fFisherCoefficients.push_back( -0.000122099908025 );
