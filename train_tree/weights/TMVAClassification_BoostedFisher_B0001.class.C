...
Method         : Fisher::BoostedFisher_B0001
...
class ReadBoostedFisher_B0001 : public IClassifierReader {

 public:

   // constructor
   ReadBoostedFisher_B0001( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadBoostedFisher_B0001" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadBoostedFisher_B0001() {
...
inline void ReadBoostedFisher_B0001::Initialize() 
{
   fFisher0 = -0.411326028445;
   fFisherCoefficients.push_back( -0.0209876673801 );
   fFisherCoefficients.push_back( 0.0632467115588 );
   fFisherCoefficients.push_back( -0.0445914971569 );
   fFisherCoefficients.push_back( 0.000304687782105 );
   fFisherCoefficients.push_back( -0.000258059168775 );
...
inline double ReadBoostedFisher_B0001::GetMvaValue__( const std::vector<double>& inputValues ) const
{
...
// Clean up
inline void ReadBoostedFisher_B0001::Clear() 
{
   // clear coefficients
   fFisherCoefficients.clear(); 
}
   inline double ReadBoostedFisher_B0001::GetMvaValue( const std::vector<double>& inputValues ) const
   {
