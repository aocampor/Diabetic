...
Method         : Fisher::BoostedFisher_B0000
...
class ReadBoostedFisher_B0000 : public IClassifierReader {

 public:

   // constructor
   ReadBoostedFisher_B0000( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadBoostedFisher_B0000" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadBoostedFisher_B0000() {
...
inline void ReadBoostedFisher_B0000::Initialize() 
{
   fFisher0 = -0.432225478067;
   fFisherCoefficients.push_back( -0.0251064834004 );
   fFisherCoefficients.push_back( 0.0769944974786 );
   fFisherCoefficients.push_back( -0.0543532062483 );
   fFisherCoefficients.push_back( 3.9528913601e-05 );
   fFisherCoefficients.push_back( -0.000407118266475 );
...
inline double ReadBoostedFisher_B0000::GetMvaValue__( const std::vector<double>& inputValues ) const
{
...
// Clean up
inline void ReadBoostedFisher_B0000::Clear() 
{
   // clear coefficients
   fFisherCoefficients.clear(); 
}
   inline double ReadBoostedFisher_B0000::GetMvaValue( const std::vector<double>& inputValues ) const
   {
