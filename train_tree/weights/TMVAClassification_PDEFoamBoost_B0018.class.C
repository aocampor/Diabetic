...
Method         : PDEFoam::PDEFoamBoost_B0018
...
class ReadPDEFoamBoost_B0018 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0018( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0018" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0018() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0018::GetMvaValue( const std::vector<double>& inputValues ) const
   {
