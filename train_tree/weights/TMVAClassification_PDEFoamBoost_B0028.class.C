...
Method         : PDEFoam::PDEFoamBoost_B0028
...
class ReadPDEFoamBoost_B0028 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0028( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0028" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0028() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0028::GetMvaValue( const std::vector<double>& inputValues ) const
   {
