...
Method         : PDEFoam::PDEFoamBoost_B0024
...
class ReadPDEFoamBoost_B0024 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0024( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0024" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0024() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0024::GetMvaValue( const std::vector<double>& inputValues ) const
   {
