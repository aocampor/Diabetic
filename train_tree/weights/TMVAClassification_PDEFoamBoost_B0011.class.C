...
Method         : PDEFoam::PDEFoamBoost_B0011
...
class ReadPDEFoamBoost_B0011 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0011( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0011" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0011() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0011::GetMvaValue( const std::vector<double>& inputValues ) const
   {
