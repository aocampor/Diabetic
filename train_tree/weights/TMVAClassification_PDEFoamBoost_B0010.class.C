...
Method         : PDEFoam::PDEFoamBoost_B0010
...
class ReadPDEFoamBoost_B0010 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0010( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0010" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0010() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0010::GetMvaValue( const std::vector<double>& inputValues ) const
   {
