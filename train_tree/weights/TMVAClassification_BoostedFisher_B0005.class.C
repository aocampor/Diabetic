...
Method         : Fisher::BoostedFisher_B0005
...
class ReadBoostedFisher_B0005 : public IClassifierReader {

 public:

   // constructor
   ReadBoostedFisher_B0005( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadBoostedFisher_B0005" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadBoostedFisher_B0005() {
...
inline void ReadBoostedFisher_B0005::Initialize() 
{
   fFisher0 = -0.315738469488;
   fFisherCoefficients.push_back( -0.0129917053013 );
   fFisherCoefficients.push_back( 0.0379835680389 );
   fFisherCoefficients.push_back( -0.0268477260898 );
   fFisherCoefficients.push_back( 0.000517729474817 );
   fFisherCoefficients.push_back( -0.000136181138098 );
...
inline double ReadBoostedFisher_B0005::GetMvaValue__( const std::vector<double>& inputValues ) const
{
...
// Clean up
inline void ReadBoostedFisher_B0005::Clear() 
{
   // clear coefficients
   fFisherCoefficients.clear(); 
}
   inline double ReadBoostedFisher_B0005::GetMvaValue( const std::vector<double>& inputValues ) const
   {
