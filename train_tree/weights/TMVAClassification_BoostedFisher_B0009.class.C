...
Method         : Fisher::BoostedFisher_B0009
...
class ReadBoostedFisher_B0009 : public IClassifierReader {

 public:

   // constructor
   ReadBoostedFisher_B0009( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadBoostedFisher_B0009" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadBoostedFisher_B0009() {
...
inline void ReadBoostedFisher_B0009::Initialize() 
{
   fFisher0 = -0.256494213096;
   fFisherCoefficients.push_back( -0.0101870258665 );
   fFisherCoefficients.push_back( 0.0293896652008 );
   fFisherCoefficients.push_back( -0.0207883367768 );
   fFisherCoefficients.push_back( 0.000485118786813 );
   fFisherCoefficients.push_back( -0.000126121846617 );
...
inline double ReadBoostedFisher_B0009::GetMvaValue__( const std::vector<double>& inputValues ) const
{
...
// Clean up
inline void ReadBoostedFisher_B0009::Clear() 
{
   // clear coefficients
   fFisherCoefficients.clear(); 
}
   inline double ReadBoostedFisher_B0009::GetMvaValue( const std::vector<double>& inputValues ) const
   {
