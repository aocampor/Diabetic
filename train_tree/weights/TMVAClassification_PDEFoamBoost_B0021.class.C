...
Method         : PDEFoam::PDEFoamBoost_B0021
...
class ReadPDEFoamBoost_B0021 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0021( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0021" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0021() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0021::GetMvaValue( const std::vector<double>& inputValues ) const
   {
