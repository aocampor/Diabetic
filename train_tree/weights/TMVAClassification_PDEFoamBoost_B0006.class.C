...
Method         : PDEFoam::PDEFoamBoost_B0006
...
class ReadPDEFoamBoost_B0006 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0006( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0006" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0006() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0006::GetMvaValue( const std::vector<double>& inputValues ) const
   {
