...
Method         : PDEFoam::PDEFoamBoost_B0029
...
class ReadPDEFoamBoost_B0029 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0029( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0029" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0029() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0029::GetMvaValue( const std::vector<double>& inputValues ) const
   {
