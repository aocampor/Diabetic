...
Method         : Fisher::BoostedFisher_B0003
...
class ReadBoostedFisher_B0003 : public IClassifierReader {

 public:

   // constructor
   ReadBoostedFisher_B0003( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadBoostedFisher_B0003" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadBoostedFisher_B0003() {
...
inline void ReadBoostedFisher_B0003::Initialize() 
{
   fFisher0 = -0.36946114368;
   fFisherCoefficients.push_back( -0.0159707535086 );
   fFisherCoefficients.push_back( 0.0473772832322 );
   fFisherCoefficients.push_back( -0.0333493496496 );
   fFisherCoefficients.push_back( 0.00046492727193 );
   fFisherCoefficients.push_back( -0.000174425668158 );
...
inline double ReadBoostedFisher_B0003::GetMvaValue__( const std::vector<double>& inputValues ) const
{
...
// Clean up
inline void ReadBoostedFisher_B0003::Clear() 
{
   // clear coefficients
   fFisherCoefficients.clear(); 
}
   inline double ReadBoostedFisher_B0003::GetMvaValue( const std::vector<double>& inputValues ) const
   {
