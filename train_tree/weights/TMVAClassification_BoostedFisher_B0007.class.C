...
Method         : Fisher::BoostedFisher_B0007
...
class ReadBoostedFisher_B0007 : public IClassifierReader {

 public:

   // constructor
   ReadBoostedFisher_B0007( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadBoostedFisher_B0007" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadBoostedFisher_B0007() {
...
inline void ReadBoostedFisher_B0007::Initialize() 
{
   fFisher0 = -0.299174836512;
   fFisherCoefficients.push_back( -0.0118183889589 );
   fFisherCoefficients.push_back( 0.034473326052 );
   fFisherCoefficients.push_back( -0.0242839797349 );
   fFisherCoefficients.push_back( 0.000494941759165 );
   fFisherCoefficients.push_back( -0.000149294963037 );
...
inline double ReadBoostedFisher_B0007::GetMvaValue__( const std::vector<double>& inputValues ) const
{
...
// Clean up
inline void ReadBoostedFisher_B0007::Clear() 
{
   // clear coefficients
   fFisherCoefficients.clear(); 
}
   inline double ReadBoostedFisher_B0007::GetMvaValue( const std::vector<double>& inputValues ) const
   {
