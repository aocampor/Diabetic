...
Method         : Fisher::BoostedFisher_B0018
...
class ReadBoostedFisher_B0018 : public IClassifierReader {

 public:

   // constructor
   ReadBoostedFisher_B0018( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadBoostedFisher_B0018" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadBoostedFisher_B0018() {
...
inline void ReadBoostedFisher_B0018::Initialize() 
{
   fFisher0 = -0.179519194846;
   fFisherCoefficients.push_back( -0.007205264233 );
   fFisherCoefficients.push_back( 0.0204840488832 );
   fFisherCoefficients.push_back( -0.0144874234902 );
   fFisherCoefficients.push_back( 0.000378416672943 );
   fFisherCoefficients.push_back( -0.000106642986299 );
...
inline double ReadBoostedFisher_B0018::GetMvaValue__( const std::vector<double>& inputValues ) const
{
...
// Clean up
inline void ReadBoostedFisher_B0018::Clear() 
{
   // clear coefficients
   fFisherCoefficients.clear(); 
}
   inline double ReadBoostedFisher_B0018::GetMvaValue( const std::vector<double>& inputValues ) const
   {
