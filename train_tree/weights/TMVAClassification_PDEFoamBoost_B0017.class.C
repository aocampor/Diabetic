...
Method         : PDEFoam::PDEFoamBoost_B0017
...
class ReadPDEFoamBoost_B0017 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0017( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0017" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0017() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0017::GetMvaValue( const std::vector<double>& inputValues ) const
   {
