...
Method         : Fisher::BoostedFisher_B0013
...
class ReadBoostedFisher_B0013 : public IClassifierReader {

 public:

   // constructor
   ReadBoostedFisher_B0013( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadBoostedFisher_B0013" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadBoostedFisher_B0013() {
...
inline void ReadBoostedFisher_B0013::Initialize() 
{
   fFisher0 = -0.201845189084;
   fFisherCoefficients.push_back( -0.00822130042066 );
   fFisherCoefficients.push_back( 0.0234497747728 );
   fFisherCoefficients.push_back( -0.0166110101541 );
   fFisherCoefficients.push_back( 0.00041778924079 );
   fFisherCoefficients.push_back( -0.000117189958372 );
...
inline double ReadBoostedFisher_B0013::GetMvaValue__( const std::vector<double>& inputValues ) const
{
...
// Clean up
inline void ReadBoostedFisher_B0013::Clear() 
{
   // clear coefficients
   fFisherCoefficients.clear(); 
}
   inline double ReadBoostedFisher_B0013::GetMvaValue( const std::vector<double>& inputValues ) const
   {
