...
Method         : PDEFoam::PDEFoamBoost_B0014
...
class ReadPDEFoamBoost_B0014 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0014( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0014" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0014() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0014::GetMvaValue( const std::vector<double>& inputValues ) const
   {
