...
Method         : Fisher::BoostedFisher_B0011
...
class ReadBoostedFisher_B0011 : public IClassifierReader {

 public:

   // constructor
   ReadBoostedFisher_B0011( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadBoostedFisher_B0011" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadBoostedFisher_B0011() {
...
inline void ReadBoostedFisher_B0011::Initialize() 
{
   fFisher0 = -0.233902983819;
   fFisherCoefficients.push_back( -0.0093659943371 );
   fFisherCoefficients.push_back( 0.0269319265495 );
   fFisherCoefficients.push_back( -0.019006026839 );
   fFisherCoefficients.push_back( 0.00044279929937 );
   fFisherCoefficients.push_back( -0.000135160409613 );
...
inline double ReadBoostedFisher_B0011::GetMvaValue__( const std::vector<double>& inputValues ) const
{
...
// Clean up
inline void ReadBoostedFisher_B0011::Clear() 
{
   // clear coefficients
   fFisherCoefficients.clear(); 
}
   inline double ReadBoostedFisher_B0011::GetMvaValue( const std::vector<double>& inputValues ) const
   {
