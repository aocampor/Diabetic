...
Method         : PDEFoam::PDEFoamBoost_B0009
...
class ReadPDEFoamBoost_B0009 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0009( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0009" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0009() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0009::GetMvaValue( const std::vector<double>& inputValues ) const
   {
