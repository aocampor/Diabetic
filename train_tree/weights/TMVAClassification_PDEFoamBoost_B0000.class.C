...
Method         : PDEFoam::PDEFoamBoost_B0000
TMVA Release   : 4.2.0         [262656]
ROOT Release   : 6.02/08       [393736]
Creator        : aocampor
Date           : Sat May 16 19:12:45 2015
...
class ReadPDEFoamBoost_B0000 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0000( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0000" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0000() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0000::GetMvaValue( const std::vector<double>& inputValues ) const
   {
