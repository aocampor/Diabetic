...
Method         : PDEFoam::PDEFoamBoost_B0023
...
class ReadPDEFoamBoost_B0023 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0023( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0023" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0023() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0023::GetMvaValue( const std::vector<double>& inputValues ) const
   {
