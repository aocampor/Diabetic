...
Method         : Fisher::BoostedFisher_B0016
...
class ReadBoostedFisher_B0016 : public IClassifierReader {

 public:

   // constructor
   ReadBoostedFisher_B0016( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadBoostedFisher_B0016" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadBoostedFisher_B0016() {
...
inline void ReadBoostedFisher_B0016::Initialize() 
{
   fFisher0 = -0.192866173313;
   fFisherCoefficients.push_back( -0.00772117661588 );
   fFisherCoefficients.push_back( 0.0220377609117 );
   fFisherCoefficients.push_back( -0.0155641638753 );
   fFisherCoefficients.push_back( 0.000390451556996 );
   fFisherCoefficients.push_back( -0.000118773559633 );
...
inline double ReadBoostedFisher_B0016::GetMvaValue__( const std::vector<double>& inputValues ) const
{
...
// Clean up
inline void ReadBoostedFisher_B0016::Clear() 
{
   // clear coefficients
   fFisherCoefficients.clear(); 
}
   inline double ReadBoostedFisher_B0016::GetMvaValue( const std::vector<double>& inputValues ) const
   {
