...
Method         : PDEFoam::PDEFoamBoost_B0019
...
class ReadPDEFoamBoost_B0019 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0019( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0019" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0019() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0019::GetMvaValue( const std::vector<double>& inputValues ) const
   {
