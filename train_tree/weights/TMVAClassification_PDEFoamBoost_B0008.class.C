...
Method         : PDEFoam::PDEFoamBoost_B0008
...
class ReadPDEFoamBoost_B0008 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0008( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0008" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0008() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0008::GetMvaValue( const std::vector<double>& inputValues ) const
   {
