...
Method         : PDEFoam::PDEFoamBoost_B0003
...
class ReadPDEFoamBoost_B0003 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0003( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0003" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0003() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0003::GetMvaValue( const std::vector<double>& inputValues ) const
   {
