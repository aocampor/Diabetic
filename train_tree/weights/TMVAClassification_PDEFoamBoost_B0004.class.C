...
Method         : PDEFoam::PDEFoamBoost_B0004
...
class ReadPDEFoamBoost_B0004 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0004( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0004" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0004() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0004::GetMvaValue( const std::vector<double>& inputValues ) const
   {
