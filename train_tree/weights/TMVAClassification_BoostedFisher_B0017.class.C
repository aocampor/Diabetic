...
Method         : Fisher::BoostedFisher_B0017
...
class ReadBoostedFisher_B0017 : public IClassifierReader {

 public:

   // constructor
   ReadBoostedFisher_B0017( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadBoostedFisher_B0017" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadBoostedFisher_B0017() {
...
inline void ReadBoostedFisher_B0017::Initialize() 
{
   fFisher0 = -0.193229113047;
   fFisherCoefficients.push_back( -0.00764495355341 );
   fFisherCoefficients.push_back( 0.0218415076583 );
   fFisherCoefficients.push_back( -0.0154112712047 );
   fFisherCoefficients.push_back( 0.000387396895467 );
   fFisherCoefficients.push_back( -0.000118513588303 );
...
inline double ReadBoostedFisher_B0017::GetMvaValue__( const std::vector<double>& inputValues ) const
{
...
// Clean up
inline void ReadBoostedFisher_B0017::Clear() 
{
   // clear coefficients
   fFisherCoefficients.clear(); 
}
   inline double ReadBoostedFisher_B0017::GetMvaValue( const std::vector<double>& inputValues ) const
   {
