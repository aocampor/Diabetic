...
Method         : Fisher::BoostedFisher_B0006
...
class ReadBoostedFisher_B0006 : public IClassifierReader {

 public:

   // constructor
   ReadBoostedFisher_B0006( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadBoostedFisher_B0006" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadBoostedFisher_B0006() {
...
inline void ReadBoostedFisher_B0006::Initialize() 
{
   fFisher0 = -0.308660192117;
   fFisherCoefficients.push_back( -0.0123472994588 );
   fFisherCoefficients.push_back( 0.0360783577122 );
   fFisherCoefficients.push_back( -0.0254561518522 );
   fFisherCoefficients.push_back( 0.000507798975417 );
   fFisherCoefficients.push_back( -0.000143201654987 );
...
inline double ReadBoostedFisher_B0006::GetMvaValue__( const std::vector<double>& inputValues ) const
{
...
// Clean up
inline void ReadBoostedFisher_B0006::Clear() 
{
   // clear coefficients
   fFisherCoefficients.clear(); 
}
   inline double ReadBoostedFisher_B0006::GetMvaValue( const std::vector<double>& inputValues ) const
   {
