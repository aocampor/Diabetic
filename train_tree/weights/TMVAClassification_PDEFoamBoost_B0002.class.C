...
Method         : PDEFoam::PDEFoamBoost_B0002
...
class ReadPDEFoamBoost_B0002 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0002( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0002" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0002() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0002::GetMvaValue( const std::vector<double>& inputValues ) const
   {
