...
Method         : PDEFoam::PDEFoamBoost_B0005
...
class ReadPDEFoamBoost_B0005 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0005( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0005" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0005() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0005::GetMvaValue( const std::vector<double>& inputValues ) const
   {
