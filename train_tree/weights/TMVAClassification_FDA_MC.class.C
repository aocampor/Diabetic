...
class ReadFDA_MC : public IClassifierReader {

 public:

   // constructor
   ReadFDA_MC( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadFDA_MC" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
...
inline void ReadFDA_MC::Initialize() 
{
   fParameter[0] = -0.332340883805108;
   fParameter[1] = 0.0799697603144374;
   fParameter[2] = -0.248056713714994;
   fParameter[3] = 0.073729344647866;
   fParameter[4] = 0.0186277417138099;
}

inline double ReadFDA_MC::GetMvaValue__( const std::vector<double>& inputValues ) const
{
...
// Clean up
inline void ReadFDA_MC::Clear() 
{
   // nothing to clear
}
   inline double ReadFDA_MC::GetMvaValue( const std::vector<double>& inputValues ) const
   {
