...
class ReadFDA_GAMT : public IClassifierReader {

 public:

   // constructor
   ReadFDA_GAMT( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadFDA_GAMT" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
...
inline void ReadFDA_GAMT::Initialize() 
{
   fParameter[0] = 0.500000000542183;
   fParameter[1] = 2.48623778577894;
   fParameter[2] = -5.81595750525594;
   fParameter[3] = 0.466954978182912;
   fParameter[4] = -6.29343561828136;
}

inline double ReadFDA_GAMT::GetMvaValue__( const std::vector<double>& inputValues ) const
{
...
// Clean up
inline void ReadFDA_GAMT::Clear() 
{
   // nothing to clear
}
   inline double ReadFDA_GAMT::GetMvaValue( const std::vector<double>& inputValues ) const
   {
