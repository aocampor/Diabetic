...
Method         : PDEFoam::PDEFoamBoost_B0027
...
class ReadPDEFoamBoost_B0027 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0027( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0027" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0027() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0027::GetMvaValue( const std::vector<double>& inputValues ) const
   {
