...
Method         : Fisher::BoostedFisher_B0015
...
class ReadBoostedFisher_B0015 : public IClassifierReader {

 public:

   // constructor
   ReadBoostedFisher_B0015( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadBoostedFisher_B0015" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadBoostedFisher_B0015() {
...
inline void ReadBoostedFisher_B0015::Initialize() 
{
   fFisher0 = -0.203126622118;
   fFisherCoefficients.push_back( -0.00804410797724 );
   fFisherCoefficients.push_back( 0.0229931261479 );
   fFisherCoefficients.push_back( -0.0162540806066 );
   fFisherCoefficients.push_back( 0.000411131764587 );
   fFisherCoefficients.push_back( -0.000116449151907 );
...
inline double ReadBoostedFisher_B0015::GetMvaValue__( const std::vector<double>& inputValues ) const
{
...
// Clean up
inline void ReadBoostedFisher_B0015::Clear() 
{
   // clear coefficients
   fFisherCoefficients.clear(); 
}
   inline double ReadBoostedFisher_B0015::GetMvaValue( const std::vector<double>& inputValues ) const
   {
