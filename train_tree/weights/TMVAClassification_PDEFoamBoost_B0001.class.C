...
Method         : PDEFoam::PDEFoamBoost_B0001
...
class ReadPDEFoamBoost_B0001 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0001( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0001" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0001() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0001::GetMvaValue( const std::vector<double>& inputValues ) const
   {
