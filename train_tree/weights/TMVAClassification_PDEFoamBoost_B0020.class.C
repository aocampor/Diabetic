...
Method         : PDEFoam::PDEFoamBoost_B0020
...
class ReadPDEFoamBoost_B0020 : public IClassifierReader {

 public:

   // constructor
   ReadPDEFoamBoost_B0020( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPDEFoamBoost_B0020" ),
        fNvars( 5 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPDEFoamBoost_B0020() {
 ...
 private:
   ...
   inline double ReadPDEFoamBoost_B0020::GetMvaValue( const std::vector<double>& inputValues ) const
   {
